  ...
  define(['jquery', 'underscore', 'backbone', 'd3', 'text!templates/modules/bar.html'], function($, _, Backbone, d3, tplBar) {
    ...
    return BarView = (function(_super) {
      ...
      BarView.prototype.drawContent = function(data) {
        ...
        d3.select('#barchart').selectAll('g.bar-g').data(data.channels).enter().append('g').attr('class', 'bar-g').attr('transform', 'translate(0,' + margin.top + ')').append('rect').attr('class', 'bar').attr('x', function(d, i) {

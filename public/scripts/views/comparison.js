      ...
      ComparisonView.prototype.updateTexts = function(data) {
        if (md.Filters['par']) {
          if (md.Filters['par'] === '1') {
            ...
            return $('p.horaires').text("Quand invite-t-on le plus ou le moins de " + data.person1.person.name + " et " + data.person2.person.name + " ? Survolez les barres circulaires pour découvrir la répartition horaire. Utilisez les barres verticales pour explorer la répartition journalière.");

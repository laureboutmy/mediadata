...
(function() {
  var bar_svg, draw_axis, draw_content, draw_tooltip, height, margin, person, width, x, y;
  ...
  draw_axis = function() {
    ...
    return bar_svg.append('g').attr('class', 'grid').attr("transform", "translate(0,60)").call(yAxis);
  };
